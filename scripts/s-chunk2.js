          ...
          W = l(function (t) {
            ...
            (t.init = function (t, e, n, i) {
              ...
              n[2] && (u = n[2]),
                ...
                (this.unit = i.unit || this.unit || F.defaultUnit),
                (this.angle = i.angle || this.angle || F.defaultAngle),
        ...
        (t.exports = function (t, e) {
          ...
          function A(e, r) {
            ...
            D ||
              ...
              (D.mouseUpOutside =
                ((d = D).mouseUpOutside && _.off(x, d.mouseUpOutside),
                u(function (e) {
                  if (d.open) {
                    var n = t(e.target);
            ...
            P || (P = "w-dropdown-toggle-" + e),
              W || (W = "w-dropdown-list-" + e),
              D.toggle.attr("id", P),
              D.toggle.attr("aria-controls", W),
              ...
              D.list.attr("id", W),
              D.list.attr("aria-labelledby", P),
              D.links.each(function (t, e) {
                e.hasAttribute("tabindex") || e.setAttribute("tabindex", "0"),
                  a.test(e.hash) &&
                    e.addEventListener("click", C.bind(null, D));
              }),
              D.el.off(h),
              D.toggle.off(h),
              D.nav && D.nav.off(h);
                  ...
                  function (t) {
                    if (!n && y.open)
                      switch (
                        ...
                        case o.ESCAPE:
                          return C(y), y.toggle.focus(), t.stopPropagation();
                        case o.ARROW_RIGHT:
                        case o.ARROW_DOWN:
                          return (
                  ...
                  function (t) {
                    if (!n) {
                      ...
                      switch (t.keyCode) {
                        case o.SPACE:
                        case o.ENTER:
                          return N(), t.stopPropagation(), t.preventDefault();
                      }
                    }
                  })
                ),
                  ...
                  m.button.on(
                    ...
                    function (t) {
                      switch (t.keyCode) {
                        ...
                        case o.ESCAPE:
                          return H(l), t.preventDefault(), t.stopPropagation();
                        case o.ARROW_RIGHT:
                        case o.ARROW_DOWN:
                        case o.HOME:
                        case o.END:
            ...
            c.preview =
              function () {
                (s = p && i.env("design")),
                  (u = i.env("editor")),
                  (n = t(document.body)),
                  (a = f.find(v)).length && (a.each(O), k(), i.resize.on(_));
              }),
            (c.destroy = function () {
